...
public abstract class ProxyAuto {
	...
	{
		DefaultServerSocket defServerSocket = null;
		defServerSocket = new DefaultServerSocket(port);
		
		defServerSocket.start();
	}
	...
	// getSelectedAuto - Returns an Automobile instance that was specified by the client
	public Automobile getSelectedAuto(Object obj)
	{
		Automobile auto = null;
		
		auto = autoLHM.getSpecificAuto((int) obj);
